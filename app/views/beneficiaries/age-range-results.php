...
<head>
    ...
    <title>Age Range Results - FSMS</title>
    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1><i class="fas fa-child"></i> Age Range Results</h1>
                    <p class="mb-0 mt-2">
                        Age Range: <?php echo htmlspecialchars($minAge ?? 0); ?> - <?php echo htmlspecialchars($maxAge ?? 120); ?> years
                    </p>
                </div>
            ...
            <?php else: ?>
                <div class="col-12">
                    <div class="alert alert-info" role="alert">
                        <i class="fas fa-info-circle"></i> No beneficiaries found in this age range.
                    </div>
                </div>
            <?php endif; ?>
        </div>
