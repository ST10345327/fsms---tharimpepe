        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="mb-0 mt-2">Searching for: "<?php echo htmlspecialchars($searchTerm ?? ''); ?>"</p>
                </div>
            ...
            <?php else: ?>
                <div class="col-12">
                    <div class="alert alert-info" role="alert">
                        <i class="fas fa-info-circle"></i> No beneficiaries found matching your search criteria.
                    </div>
                </div>
            <?php endif; ?>
        </div>
