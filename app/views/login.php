...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="Tharimpepe FSMS">
    <title>FSMS Login - Tharimpepe Feeding Scheme</title>
    <link rel="manifest" href="/manifest.json">
    <link rel="apple-touch-icon" href="/assets/images/generate_raster.php?name=tharimpepe-logo&w=192&h=192&dpr=1">
    ...
    <style>
        ...
        /* Show mission column on desktop only */
        @media (min-width: 768px) {
            .login-mission {
                display: flex;
            }
